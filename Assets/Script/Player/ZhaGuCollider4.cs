...
public class ZhaGuCollider4 : MonoBehaviour {
	...
	public TrailingMesh2 trailingmesh;
	public Animator ani;
	...
	float[][] action_ani_doingtime={new float[]{0.45f,0.45f,0.4f,0.4f,0.4f},
									new float[]{2f},
	...
	float[] additional_ani_delaytime={2.6f,0.05f};//过了这个时间后才能再进行动作（与additional_ani_doingtime时间之差为攻击时间间隔）
